...
TAG="v10.0.60"
ASSET="UltraStalker_V7.2.4.ipk"
IPK_URL="$REPO/releases/download/$TAG/$ASSET"
EXPECTED_SHA256="32ae2900d5ce8df14220a7c5767329016c491ca409d60941eda5107c1ab0b92b"
TMP_IPK="/tmp/$ASSET"
...
opkg install --force-overwrite --force-reinstall "$TMP_IPK" || \
